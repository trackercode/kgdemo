...
import com.mvc.kgdemo.common.text.StrFormatter;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils implements Serializable {
    ...
    /**
     * 获取固定长度的流水号，以startStr�?��，val结尾，不足length前面�?
     *
     * @param strarStr
     * @param val
     * @param lenth
     * @return
     */
    public static String getFlowCode(String strarStr, Object val, int lenth) {
        for (int i = 0; i < lenth - val.toString().length(); i++) {
            strarStr += "0";
        }
        strarStr += val.toString();
        return strarStr;
    }
